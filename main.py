...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://127.0.0.1:8000"],  # Update with your client's origin
...
@app.get("/pdf")
async def get_df():
    pdf_path = "D:\PYTHONAPI\project\APIDesignJustification.pdf"
...
async def chat_with_ai(user_input: str = Query(...)):
    ...
    console.error("input_text:", user_input);
